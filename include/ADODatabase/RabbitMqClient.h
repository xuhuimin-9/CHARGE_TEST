...
public:
	...
	* @return		int32_t			0表示成功，其他失败
	*/
	int32_t ConsumerMessage(std::string &routing_key, std::string &message, uint64_t &delivery_tag, const std::string &queue_name_, timeval timeout = { 5, 0 }, std::string &ErrorReturn = std::string(""));
	// TODO 添加注释 确认消息
