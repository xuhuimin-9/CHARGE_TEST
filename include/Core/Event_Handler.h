...
public:  
	...
	bool Sub_Task_Dispatch_Event(Sub_Task* current_sub_task, Task_Chain* task, bool pre_search = true, std::string & ErrorMsg = std::string(""));
	...
	bool ForbidPathByReserveStorage(std::string task_from_, std::string task_to_, std::string &ErrorReturn = std::string(""));
public:
