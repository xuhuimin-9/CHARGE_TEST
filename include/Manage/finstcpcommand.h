...
#endif // !_SILENCE_CXX17_ALLOCATOR_VOID_DEPRECATION_WARNING
...
public:
	...
	bool fins_readbit(const char* start, bool* resdata, std::size_t num_bits, std::string &msg = std::string(""));
...
public:
	...
	bool clear_plc_connect() {
		for each (auto var in PLC_driver_map)
		{
			delete var.second;
			var.second = nullptr;
		}
