...
class MainWindow: public QMainWindow,public Storage_Status_Notifier, public Station_Status_Notifier/*, public MainWindowDelegate*/, public RabbitMQ_Service_Notifier, public Confirm_Status_Notifier
{
	Q_OBJECT
...
private:
	...
	QMenu *OrderActionMenu;
	QAction *order_start_;
	QAction *order_stop_;
...
private slots:
	...
	void OnConfirmStatusChanged(Confirm station);
	...
	void changeStorageTrayType(std::string storage_name, std::string type);
