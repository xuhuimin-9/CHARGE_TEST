...
signals:
	...
	void sendChangeTrayType( std::string storage_name_, std::string type);
...
public slots:
	...
	void sendChangeTo220(bool flag);
	void sendChangeTo236(bool flag);
	void sendChangeTo255(bool flag);
	void sendChangeIdleSignal(bool flag);
	void sendChangeReserveSignal(bool flag);
