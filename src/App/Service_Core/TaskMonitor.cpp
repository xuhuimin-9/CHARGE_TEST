...
void Task_Monitor::updateProgressValue()
{
	...
	for (; it != full_task_list.end(); ++it)
	{
		...
		case TASK_CHAIN_STATUS::BUFFER_PUT: status = tr("BUFFER_PUT"); break;
		...
		case TASK_CHAIN_STATUS::EXIT_BUFFER_CHECK: status = tr("EXIT_BUFFER"); break;
		...
		case TASK_CHAIN_STATUS::EQUIP_GET_RELEASE_CHECK: status = tr("EQUIP_GET_RELEASE_CHECK"); break;
		case TASK_CHAIN_STATUS::GET_GOODS_BUFFER_CONFIRM_CHECK: status = tr("GET_GOODS_BUFFER_CONFIRM"); break;
		case TASK_CHAIN_STATUS::PUT_GOODS_BUFFER_CONFIRM_CHECK: status = tr("PUT_GOODS_BUFFER_CONFIRM"); break;
		case TASK_CHAIN_STATUS::GET_GOODS_BUFFER_RELEASE_CHECK: status = tr("GET_GOODS_BUFFER_RELEASE"); break;
		case TASK_CHAIN_STATUS::PUT_GOODS_BUFFER_RELEASE_CHECK: status = tr("PUT_GOODS_BUFFER_RELEASE"); break;
		case TASK_CHAIN_STATUS::GET_TRAY_BUFFER_CONFIRM_CHECK: status = tr("GET_TRAY_BUFFER_CONFIRM"); break;
		case TASK_CHAIN_STATUS::TRAY_RELEASE_CHECK: status = tr("TRAY_RELEASE"); break;
		case TASK_CHAIN_STATUS::TRAY_BUFFER_RELEASE_CHECK: status = tr("TRAY_BUFFER_RELEASE"); break;
		...
		rowset.push_back(task->Get_Start_Time());
		data.append(rowset);
	}
