...
void log_warning(std::string fmt) {
	log_warning(fmt.c_str());
}
...
void log_fatal(std::string fmt) {
	log_fatal(fmt.c_str());
}

void log_trace_color(log_color color, std::string fmt) {
	log_trace_color(color, fmt.c_str());
}

void log_debug_color(log_color color, std::string fmt) {
	log_debug_color(color, fmt.c_str());
}

void log_info_color(log_color color, std::string fmt) {
	log_info_color(color, fmt.c_str());
}

void log_warning_color(log_color color, std::string fmt) {
	log_warning_color(color, fmt.c_str());
}

void log_error_color(log_color color, std::string fmt) {
	log_error_color(color, fmt.c_str());
}

void log_fatal_color(log_color color, std::string fmt) {
	log_fatal_color(color, fmt.c_str());
}